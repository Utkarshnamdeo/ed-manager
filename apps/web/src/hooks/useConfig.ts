...
import { type DanceStylesConfig, type ClassLevelsConfig, DanceStyle, ClassLevel } from '../types';

// ─── Dance Styles ─────────────────────────────────────────────────────────────

const DANCE_STYLES_KEY = ['config', 'danceStyles'] as const;

const DEFAULT_DANCE_STYLES = [DanceStyle.Bachata, DanceStyle.Kizomba, DanceStyle.Salsa, DanceStyle.Zouk, DanceStyle.Afro, 'other'];
...
const DEFAULT_CLASS_LEVELS = [ClassLevel.Beginner, ClassLevel.Intermediate, ClassLevel.Advanced, ClassLevel.Open];
